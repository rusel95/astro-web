...
- **Body:** `text-base` (16px) -- minimum size for all body text on all viewports (per FR-029a)
- **Labels/secondary:** `text-sm` (14px) -- minimum for labels, captions, and secondary text
- **Small/hint:** `text-xs` (12px) -- absolute minimum, only for timestamps and tertiary hints. Never for body text
...
- **Text sizing:** Body text remains 16px on mobile (per FR-029a). Labels inside tables may use 14px (`text-sm`)
