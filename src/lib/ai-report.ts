...
const FEATURE_PROMPTS: Record<string, { systemContext: string; focusAreas: string }> = {
  ...
  composite: {
    systemContext: 'композитна карта — середня точка між двома натальними картами, показує енергію стосунків як єдине ціле',
    focusAreas: 'сутність стосунків (Сонце), емоційний фон (Місяць), комунікація (Меркурій), кохання і цінності (Венера), сексуальність і конфлікти (Марс), спільний розвиток (Юпітер/Сатурн)',
  },
  synastry: {
    systemContext: 'синастрія — порівняння двох натальних карт для аналізу сумісності та динаміки стосунків',
    focusAreas: 'міжаспекти між картами, накладки планет на доми партнера, емоційна і сексуальна сумісність, зони конфліктів і зростання',
  },
};
